...
export default function AdminDashboardPage() {
  ...
  const quickActions = [
    ...
    {
      title: "Manage Users",
      description: "View students and administrators",
      icon: Users,
      href: "/admin/users",
    },
    {
        ...
        <div className="p-5 md:p-8">
          ...
          <footer className="mt-8 border-t border-slate-200 pt-5">
            <div className="flex flex-col justify-between gap-2 text-xs text-slate-400 sm:flex-row">
              <p>© 2026 TopStudyTutor. Admin Portal.</p>

              <p>
                Secure Administration •{" "}
                <span className="text-green-600">System Protected</span>
              </p>
            </div>
          </footer>
        </div>
